...
public void afterScenario(Scenario scenario) throws IOException {
	if(scenario.isFailed()) {
		...
		File DestFile = new File(System.getProperty("user.dir") + "/target/cucumber/" + scenario.getName() + ".png");
	try {
	...
	Reporter.addScreenCaptureFromPath(System.getProperty("user.dir") + "/target/cucumber/" + scenario.getName() + ".png", "Failed Screenshot");
	}
