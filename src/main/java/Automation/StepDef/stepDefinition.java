...
public class stepDefinition extends SuiteBase {
	...
	public void i_validate_that_values_are_saved_and_confirmation_message_is_populated(String Message) throws Throwable {
		PageFactory.initElements(SuiteBase.driver, MyProfile_PageObjects.class);
	...
	public void i_validate_that_Site_is_added_successfully_with_URL_and_description(String URL, String Description) throws Throwable {
		assertTrue(myprofile_Actions.presenceOfURLonLinks(URL,Description));
	}
