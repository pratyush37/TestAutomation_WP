...
public class SuiteBase {
	...
	public static void init() throws IOException{
		...
		FileInputStream FIS = new FileInputStream(System.getProperty("user.dir") + "//src//main//java//Automation//Properties//parameter.properties");
	    Parameter  = new Properties();
	    Parameter.load(FIS);
	    
	    
	    //Logger
	    String log4jConfigPath = System.getProperty("user.dir") + "//src//main//java//Automation//Properties//log4j.properties";
